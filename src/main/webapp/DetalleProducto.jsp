			...
			<div class="col-lg-5 mt-5">
				<div class="card mb-3">
					<img class="card-img img-fluid"
						src="img/products/<%=producto.getImagen()%>" alt="Card image cap"
						id="product-detail">
				</div>
			</div>
					...
					<form action="AñadirProductoServlet" method="GET">
						...
						<div class="col-auto">
							<ul class="list-inline pb-3" style="margin-left: 15px;">
								<li class="list-inline-item text-right"><h6>Quantity</h6></li>
					...
					<%} else{%>
						...
						<div class="form-group pt-4">
							<a href="/TIENDA_ISMAEL_FERRERAS"
								style="background: #f0f0f0; color: black; width:200px"
